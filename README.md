...
> [!WARNING]
> Abstract 和 Introduction 中的强 claim 最容易触发 reviewer 质疑。没有证据支撑的 claim 不要硬写。
...
| 什么情况下有效/无效 | analysis / robustness / failure cases | 说明边界，避免夸大 |
...
|---|---|---|
| `[2]` | 文献序号 | 正文中用 `[2]` 对应引用 |
| 作者 | `MILDENHALL B, SRINIVASAN P P, TANCIK M, et al` | 中文 GB/T 风格常用姓在前、名缩写；作者多时用“等” |
